...
etiketlenenKişi.setNickname(`${ayarlar.tag2} ${isim} ${ayarlar.sembol} ${yaş}`)

message.react(client.emojis.cache.get(ayarlar.yes))

const arwEmbed = new Discord.MessageEmbed()
.setColor("RANDOM")
.setDescription(`Kullanıcının ismi \`${ayarlar.tag2} ${isim} ${ayarlar.sembol} ${yaş}\` olarak değiştirildi ve <@&${ayarlar.erkekRol1}>, <@&${ayarlar.erkekRol2}> <@&${ayarlar.erkekRol3}> rolleri verildi!`)
...
client.channels.cache.get(ayarlar.sohbetKanal).send(`${etiketlenenKişi}  ***Sunucumuza Hoşgeldin Seste ve Chatte Aktif Kalırsan Bizi Çok Mutlu Edersin İyi Eğlenceler!***`)
