...
.setColor("RANDOM")
.setDescription(`Kullanıcının ismi \`${ayarlar.tag2} ${isim} ${ayarlar.sembol} ${yaş}\` olarak değiştirildi ve <@&${ayarlar.kadınRol1}>, <@&${ayarlar.kadınRol2}> <@&${ayarlar.kadınRol3}> rolleri verildi!`)
